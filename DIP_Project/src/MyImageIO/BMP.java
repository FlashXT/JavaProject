	...
	//define the bitmap data field
	 ...
	 public String toString(){
		...
		//输出颜色表
		 ...
		 try {
				fos = new FileOutputStream("images\\colorTable.txt");				
		 ...
		 //输出图像数据，from the bottom left to the upper height 	 
		 System.out.println("The bitmap data field:\n\t\t\tbtimapData.txt");
		 try {
				fos2 = new FileOutputStream("images\\bitmapData.txt");
...
//			BMP test = new BMP("images\\lena.bmp");
//			test.toString();	
//		}
